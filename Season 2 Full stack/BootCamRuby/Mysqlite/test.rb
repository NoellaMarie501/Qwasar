...
class MySqliteRequest
  ...
  #from instance and class methods
  ...
  #select instance and class methods
  ...
  #Where instance and class methods
  ...
  #Join instance and class methods
  ...
  #Order instance and class methods
  ...
  #Insert instance and class methods
  ...
  #Values instance and class methods
  ...
  #Updae instance and class methods
  ...
  #Set instance and class methods
    def self.set(data)
      @update_data = data
      self
    end
  ...
  #Delete instance and class methods
    def self.delete
